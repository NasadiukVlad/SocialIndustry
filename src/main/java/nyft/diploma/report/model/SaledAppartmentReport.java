 ...
 */
public class SaledAppartmentReport {
    ...
    public SaledAppartmentReport(Long appartmentCode, String adress, Long price, Long appartmentNumber, Long area, Long developerCode) {
